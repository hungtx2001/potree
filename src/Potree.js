...
export {CesiumControls} from "./navigation/CesiumControls.js";
  ...
  $.fn.extend({
    selectgroup: function (args = {}) {
      ...
      elGroup.find("option").each((index, value) => {
        ...
        let dataI18n = $(value).attr("data-i18n");
        let i18nAttr = dataI18n ? `data-i18n="${dataI18n}"` : "";

        let elButton = $(`
					<span style="flex-grow: 1; display: inherit">
					<label for="${buttonID}" ${i18nAttr} class="ui-button" style="width: 100%; padding: .4em .1em">${label}</label>
