...
export class Sidebar {
  ...
  initScene() {
    ...
    let pcID = tree.jstree('create_node', "#", {
      "text": "<b data-i18n='tb.point_clouds'>Point Clouds</b>",
      "id": "pointclouds"
    }, "last", false, false);
    let measurementID = tree.jstree('create_node', "#", {
      "text": "<b data-i18n='tb.measurments_opt'>Measurements</b>",
      "id": "measurements"
    }, "last", false, false);
    let annotationsID = tree.jstree('create_node', "#", {
      "text": "<b data-i18n='tb.annotations_opt'>Annotations</b>",
      "id": "annotations"
    }, "last", false, false);
    let otherID = tree.jstree('create_node', "#", {
      "text": "<b data-i18n='tb.other_opt'>Other</b>",
      "id": "other"
    }, "last", false, false);
    let vectorsID = tree.jstree('create_node', "#", {
      "text": "<b data-i18n='tb.vectors_opt'>Vectors</b>",
      "id": "vectors"
    }, "last", false, false);
    let imagesID = tree.jstree('create_node', "#", {
      "text": "<b data-i18n='tb.images_opt'> Images</b>",
      "id": "images"
    }, "last", false, false);
